...
pub struct RenderConfig {
    ...
    pub toy: WgpuToyRenderer,
}

//impl RenderConfig {
//    pub fn new(output_surface: &OutputSurface, shader_source: &str) -> Result<Self> {
//        let ctx = output_surface.ctx();
//        let toy = WgpuToyRenderer::new(ctx);
//        let map = block_on(toy.preprocess_async(shader_source)).ok_or_else(|| anyhow!("idk"))?;
//        println!("{}", map.source);
//
//        let frag_shader = output_surface.create_shader_module(wgpu::ShaderModuleDescriptor {
//            label: Some("fragment_shader"),
//            source: wgpu::ShaderSource::Wgsl(map.source.into()),
//        });
//
...
//        block_on( self.toy.render_async());
//        /*
